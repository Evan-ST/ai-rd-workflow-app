...
// ========== 用户列表（从飞书多维表格同步的真实人员数据） ==========
const USERS = [
  // 产品部
  { id: 'ou_71d28be3db5bf7db54e46ae07ad6cf6a', name: '曲兆天', role: 'dept_manager', title: '产品部经理', department: '产品部', deptKey: 'product', avatar: '👤' },
  { id: 'ou_7d1882efeefb649f3da394f766e432b1', name: '黄舒祥', role: 'product_manager', title: '产品经理', department: '产品部', deptKey: 'product', avatar: '📝' },
  { id: 'ou_b4be741f84b10d141d7debf0b82c11a5', name: '宋茂', role: 'product_manager', title: '产品经理', department: '产品部', deptKey: 'product', avatar: '📝' },
  { id: 'ou_0173ff1d4591d9d65dc2be9abdf53b60', name: '马扬雯', role: 'engineer', title: '品牌设计', department: '产品部', deptKey: 'product', specialty: '品牌设计', avatar: '🎨' },
  { id: 'ou_e0234e8d2f1d2f9f9b3d4dd3dd7464af', name: '叶文彬', role: 'engineer', title: '平面设计', department: '产品部', deptKey: 'product', specialty: '平面设计', avatar: '🎨' },
  { id: 'ou_f76181b40b6c37d196d908ac24a396da', name: '曾宗长', role: 'product_manager', title: '产品经理', department: '产品部', deptKey: 'product', avatar: '📝' },
  { id: 'ou_e727e2b0e3ab376ce88398768e5877f5', name: '吴茂杰', role: 'product_manager', title: '产品经理', department: '产品部', deptKey: 'product', avatar: '📝' },
  { id: 'ou_a96402ffc7c6e176d90a25bba39da7fc', name: '张宇佳', role: 'product_manager', title: '产品经理', department: '产品部', deptKey: 'product', avatar: '📝' },
  // 项目部
  { id: 'ou_37e218ae818ced170b7081bc087a9128', name: '王佳磊', role: 'dept_manager', title: '项目部经理', department: '项目部', deptKey: 'project', avatar: '👔' },
  { id: 'ou_baf386d1f5b9a524e82915d9d669de55', name: '陈希希', role: 'project_manager', title: '项目经理', department: '项目部', deptKey: 'project', avatar: '📊' },
  { id: 'ou_06d12e2ae607069789b67a900f86f458', name: '胡杰', role: 'project_manager', title: '项目经理', department: '项目部', deptKey: 'project', avatar: '📋' },
  { id: 'oc_a7da8478b2b740e40e89f7e034f9ace8', name: '蒋俊', role: 'project_manager', title: '项目经理', department: '项目部', deptKey: 'project', avatar: '📋' },
  { id: 'ou_86db991f3e434e041eb84d14f55cc6b8', name: '宁武彪', role: 'project_manager', title: '项目经理', department: '项目部', deptKey: 'project', avatar: '📊' },
  { id: 'ou_c16f335ae306c5bfd3aee415575d5d06', name: '申奥', role: 'project_manager', title: '项目经理', department: '项目部', deptKey: 'project', avatar: '📊' },
  { id: 'ou_a14c4e059b6dfe3912c9d278aa4d8493', name: '王妮', role: 'project_manager', title: '项目经理', department: '项目部', deptKey: 'project', avatar: '📊' },
  { id: 'ou_585499e9f44a9d57013a3c8aca212053', name: '文桂敏', role: 'project_manager', title: '项目经理', department: '项目部', deptKey: 'project', avatar: '📋' },
  { id: 'ou_35ed859d14ce405662713cddfea30e98', name: '周建华', role: 'project_manager', title: '项目经理', department: '项目部', deptKey: 'project', avatar: '📊' },
  { id: 'oc_6f997b4ac18c070df0a1bef6416ba1b6', name: '陈玲玲', role: 'engineer', title: '项目助理', department: '项目部', deptKey: 'project', specialty: '项目助理', avatar: '📎' },
  { id: 'ou_9d5207ad7c7d94caf204a11fc9fa1de0', name: '罗丽', role: 'engineer', title: '项目助理', department: '项目部', deptKey: 'project', specialty: '项目助理', avatar: '📎' },
  { id: 'ou_d8fd42f43b0f6a0a40e104e146d631ef', name: '苏龙', role: 'engineer', title: '项目助理', department: '项目部', deptKey: 'project', specialty: '项目助理', avatar: '📎' },
  { id: 'oc_bc5f09d8fa5126de4a3754f2d5f2726e', name: '陈峥', role: 'engineer', title: '项目助理', department: '项目部', deptKey: 'project', specialty: '项目助理', avatar: '📎' },
  ...
  { id: 'ou_53f1ebbc4306bcad2f2f7697abc0aa20', name: '覃文观', role: 'engineer', title: '硬件测试工程师', department: '硬件研发部', deptKey: 'hardware', specialty: '硬件测试工程师', avatar: '🧪' },
  { id: 'ou_9039cfdcc3192820e5f8124dbe4dba38', name: '胡云平', role: 'engineer', title: 'Layout工程师', department: '硬件研发部', deptKey: 'hardware', specialty: 'Layout工程师', avatar: '📐' },
  { id: 'ou_b5ae148d220d22f947f88f9f32582a0d', name: '邱惠婷', role: 'engineer', title: 'Layout工程师', department: '硬件研发部', deptKey: 'hardware', specialty: 'Layout工程师', avatar: '📐' },
  ...
  { id: 'ou_d8eecfecdac452e8a764b30080f3c68c', name: '杨杰', role: 'engineer', title: '后端工程师', department: '软件组', deptKey: 'software', specialty: '后端开发', avatar: '⌨️' },
  { id: 'ou_c947af89b79b6615dbb4374868480d4c', name: '曾凯珑', role: 'engineer', title: '后端工程师', department: '软件组', deptKey: 'software', specialty: '后端开发', avatar: '⌨️' },
  { id: 'ou_166c402e2cfdca538cb1486fd5634754', name: '南晨旭', role: 'engineer', title: '后端工程师', department: '软件组', deptKey: 'software', specialty: '后端开发', avatar: '⌨️' },
  { id: 'ou_f7c6228b849bc353fddbf89fe595e8a6', name: '谭远向', role: 'engineer', title: '后端工程师', department: '软件组', deptKey: 'software', specialty: '后端开发', avatar: '⌨️' },
  { id: 'ou_d4911ecc35c0ed7d25cf00c983379806', name: '王健康', role: 'engineer', title: '后端工程师', department: '软件组', deptKey: 'software', specialty: '后端开发', avatar: '⌨️' },
  { id: 'ou_fe11a8f8bada8b03880aeb18d62dc44d', name: '吴琼华', role: 'engineer', title: '后端工程师', department: '软件组', deptKey: 'software', specialty: '后端开发', avatar: '⌨️' },
  { id: 'ou_a6d00e8fad4698dc1d41b6bbb4c1f40d', name: '张少玲', role: 'engineer', title: '后端工程师', department: '软件组', deptKey: 'software', specialty: '后端开发', avatar: '⌨️' },
  { id: 'oc_ed068d0e9672f677b86d11b371a84152', name: '杨涌彪', role: 'engineer', title: '算法工程师', department: '软件组', deptKey: 'software', specialty: '算法', avatar: '🧠' },
  { id: 'ou_430bec323f64c359604f6ff74633b962', name: '黄智红', role: 'engineer', title: '软件测试工程师', department: '软件组', deptKey: 'software', specialty: '软件测试', avatar: '🔍' },
  { id: 'ou_52caad12ee0c6edfdcd11815aa1568cf', name: '陈京', role: 'engineer', title: '软件测试工程师', department: '软件组', deptKey: 'software', specialty: '软件测试', avatar: '🔍' },
  { id: 'oc_f585decde84b09637828944771ed5113', name: '陈丽鑫', role: 'engineer', title: '软件测试工程师', department: '软件组', deptKey: 'software', specialty: '软件测试', avatar: '🔍' },
  { id: 'ou_c4c3fbf4ca4330f8943d6779b22b09ef', name: '林远明', role: 'engineer', title: '软件测试工程师', department: '软件组', deptKey: 'software', specialty: '软件测试', avatar: '🔍' },
  { id: 'ou_179b487bd8aa94e360de7cf0b1b9bebd', name: '刘乡明', role: 'engineer', title: '软件测试工程师', department: '软件组', deptKey: 'software', specialty: '软件测试', avatar: '🔍' },
  { id: 'ou_069815b763d6310a14dd8b2bfddb1020', name: '苏丽妙', role: 'engineer', title: '软件测试工程师', department: '软件组', deptKey: 'software', specialty: '软件测试', avatar: '🔍' },
  { id: 'oc_0b570b0232f7db4736b7440fb5eb71ed', name: '张锐', role: 'engineer', title: '软件测试工程师', department: '软件组', deptKey: 'software', specialty: '软件测试', avatar: '🔍' },
  { id: 'oc_46ced477bffce9acb3f52ede3e154d68', name: '张婷', role: 'engineer', title: '软件测试工程师', department: '软件组', deptKey: 'software', specialty: '软件测试', avatar: '🔍' },
  { id: 'ou_02df51c1fa575dd6fa6a1e9daf4dc58a', name: '吴贵群', role: 'engineer', title: '软件测试工程师', department: '软件组', deptKey: 'software', specialty: '软件测试', avatar: '🔍' },
  // 工程部（暂无飞书数据，待补充）
  { id: 'eng_lead', name: '工程部经理', role: 'dept_lead', title: '工程部经理', department: '工程部', deptKey: 'engineering', avatar: '🏭' },
  // 品质部（暂无飞书数据，待补充）
  { id: 'qa_lead', name: '品质部经理', role: 'dept_lead', title: '品质经理', department: '品质部', deptKey: 'quality', avatar: '✅' },
];
...
const DEPARTMENTS = [
  ...
  { key: 'engineering', name: '工程部', icon: '🏭', leadId: 'eng_lead', leadName: '工程部经理' },
  { key: 'quality', name: '品质部', icon: '✅', leadId: 'qa_lead', leadName: '品质部经理' },
];
